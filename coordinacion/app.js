        ...
        coordinadoresGrid.addEventListener("click", (e) => {
            ...
            if (coord) {
                ...
                if (coord.socials.linkedin) {
                    socialsHTML += `
                        <a href="${coord.socials.linkedin}" target="_blank" class="coord-social-btn" aria-label="LinkedIn">
                ...
                if (coord.socials.instagram) {
                    socialsHTML += `
                        <a href="${coord.socials.instagram}" target="_blank" class="coord-social-btn" aria-label="Instagram">
